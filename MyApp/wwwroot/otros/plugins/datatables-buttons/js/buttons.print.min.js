...
a():c.setTimeout(a,1E3)}else e.buttons.info(e.i18n("buttons.printErrorTitle","No se puede abrir la vista de impresión"),e.i18n("buttons.printErrorMsg","Permita las ventanas emergentes en su navegador para que este sitio pueda ver la vista de impresión."),5E3)},title:"*",messageTop:"*",messageBottom:"*",exportOptions:{},header:!0,footer:!1,autoPrint:!0,customize:null};return u.Buttons});
